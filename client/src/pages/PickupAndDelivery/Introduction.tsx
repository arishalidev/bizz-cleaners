...
const Introduction: React.FC<IntroductionProps> = ({}) => {
    return (
        <div className={"px-4 py-2"}>
            <Headline className={"mb-2"}>Skip the trip. We'll come to you.</Headline>
            <Body>Between work, school drop-offs, and the dog who somehow always needs something — driving to the cleaners shouldn't be one more thing on your list. We've spent the last six years picking up and dropping off across North DFW, including [Neighborhood names].<br/>
            ...
            <img src={businessInfo} alt={"Font of Bizz Cleaners store"} className={"rounded-md drop-shadow-md my-8"}/>
        </div>
