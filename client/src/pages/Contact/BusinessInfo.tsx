...
const BusinessInfo: React.FC<BusinessInfoProps> = ({ hoursOfOperation, isOpen } : BusinessInfoProps) => {
    ...
    return (
        <div className={"bg-white"}>
            <div className={"flex flex-col gap-6 responsive-px limit-size responsive-py -mt-4 lg:-mt-6"}>
                <div className={"max-w-200 flex-col flex gap-1"}>
                    <Body subtext={true}>Have a question about an order? Looking for a quote on a specialty item? Need help getting
                        started with pickup and delivery?</Body>
                    <Body subtext={true}>Give us a call, send us a message, or stop by the store. Our team is always happy to
                        help.</Body>
                    <Body subtext={true}>Business hours, directions, and contact information can be found below.</Body>
