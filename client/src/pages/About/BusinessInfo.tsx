...
const BusinessInfo: React.FC<BusinessInfoProps> = ({ hoursOfOperation, isOpen } : BusinessInfoProps) => {
    ...
    return (
        <div className={"bg-white"}>
            <div className={"flex flex-col gap-6 responsive-px limit-size-5xl responsive-py"}>
                <div>
                    <Headline>Stop by and say hello!</Headline>
                </div>
                ...
                <div>
                    ...
                    <div className={"mt-2 max-w-140 flex flex-col gap-2 mb-6"}>
                        <Body subtext={true}>If you need same-day service, pickup and
                            delivery, or help caring for a special garment, we'd love the opportunity to help. </Body>
                        <Body subtext={true}>Visit our Flower Mound store, schedule a pickup online, or give us a call.
                            We look forward to
                            serving you.</Body>
                    </div>
