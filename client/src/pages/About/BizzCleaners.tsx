    ...
    return (
        <div className={"bg-neutral-900"}>
            <div className={"flex flex-col gap-5 responsive-px limit-size py-10"}>
                ...
                <div className={"flex flex-col gap-4 mx-auto max-w-5xl text-white"}>
                    <Headline>More than just a dry cleaner</Headline>
                    <Body>Bizz Cleaners is family-owned, and Flower Mound has been our home for 6 years now. We're proud
                        to be part of this community — not just a stop on your errand list.</Body>
                    <Body>We dry clean the eco-friendly way, which means gentler results for your clothes and fewer
