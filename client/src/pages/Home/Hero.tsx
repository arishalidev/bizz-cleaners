...
function Hero() {
    ...
    return (
        <div className={"relative"} ref={heroRef}>
            ...
            <div className={"absolute inset-0 bg-[hsla(0,0%,0%,.15)]"}></div>
            ...
            <div className={"responsive-px limit-size"}>
                <div className={"absolute top-24 lg:top-30 text-white space-y-2"}>
                    ...
                    <h2 className={"text-xl lg:text-2xl text-shadow-lg font-normal"}>Proudly serving Flower Mound,<br className={"max-[500px]:hidden"}/> Highland Village, Lewisville,<br className={"max-[500px]:hidden"}/> and surrounding communities</h2>
