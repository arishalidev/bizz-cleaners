...
function SpecialtyService({title, description, link, image, imageAlt}: SpecialtyServiceProps) {
    return (
        <div className={"md:max-w-200"}>
            ...
            <Link to={link} className={"inline-flex items-center h-full gap-1 text-primary-400 font-semibold relative"}><Body>Learn
                More</Body><GoArrowRight className={"md:text-xl"}/>
