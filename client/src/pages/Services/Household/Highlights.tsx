    ...
    return (
        <div className={"responsive-py responsive-px limit-size-5xl"}>
            ...
            <div className={"flex flex-col justify-center place-items-center gap-6 mt-6"}>
                <Highlight Icon={BiSolidBlanket} text={"Comforters and blankets"} badge={"neutral"}
                ...
                <Highlight Icon={GiPillow} text={"Pillows"} badge={"neutral"}
                ...
                <Highlight Icon={MdCurtainsClosed} text={"Curtains and drapes"} badge={"neutral"}
                ...
                <Highlight Icon={RiBearSmileFill} text={"Stuffed animals"} badge={"neutral"}
